 ...
 *
 * This file contains the declaration of the ThrusterVisualization class, which
 * is responsible for visualizing thruster forces in ROS.
 */
 ...
 *
 * The ThrusterVisualization class is a ROS node that subscribes to thruster
 * forces and publishes visualization markers.
 */
...
private:
  /**
   * @brief Publishes visualization_msg MarkerArray of type arrow according to
   * the thruster positions, orientations and thruster forces data.
   */
  void publish_markers();

  /**
   * @brief Callback function for setting thruster data equal to the thruster
   * forces message.
  ...
  create_total_force_marker(double total_force_magnitude,
                            double total_force_orientation);
   ...
   */
  visualization_msgs::msg::Marker
  create_arc_marker(const std::string &frame_id, int id,
                    const geometry_msgs::msg::Point &center, double radius,
                    double start_angle, double end_angle, int num_segments);
   ...
   */
  visualization_msgs::msg::Marker
  create_torque_direction_marker(const std::string &frame_id, int id,
                                 const geometry_msgs::msg::Point &center,
                                 double radius, double final_angle,
