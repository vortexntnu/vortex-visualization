...
ThrusterVisualizationAUV::ThrusterVisualizationAUV() : Node("thruster_visualization_auv_node") {
    publisher_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("visualization_marker", 10);
    subscription_ = this->create_subscription<vortex_msgs::msg::ThrusterForces>("thrust/thruster_forces", 10, std::bind(&ThrusterVisualizationAUV::topic_callback, this, std::placeholders::_1));
...
void ThrusterVisualizationAUV::topic_callback(const vortex_msgs::msg::ThrusterForces &msg) {
